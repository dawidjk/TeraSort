...
<p>The ultimate goal of this project is to learn! With that being said, here are the things I set out to accomplish with this project:</p>
<ul>
<li>Learn to use Kubernetes</li>
<li>Experiment with distributed systems</li>
<li>Improve optimization skills</li>
<li>Learn Golang</li>
<li>Build my very own cluster</li>
</ul>
